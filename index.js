...
client.on("message", (message) => {
    ...
    if (fun.commandsWithNoCommands(message.content.toLowerCase()) === "symphogear" || message.author.nickname.toLowerCase() === 'symphogear' || message.author.displayName.toLowerCase() === 'symphogear') {
        allowed = true;
        notification = false;
