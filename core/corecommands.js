...
module.exports = {
    ...
    help: function(commandPrefix, message) {
        let embed = new Discord.RichEmbed()
            ...
            .addField(commandPrefix+"t <languagecode> > <text/messageid>", "🇨🇳 🇺🇸 🇫🇷 🇪🇸 🇮🇹 🇷🇺 🇬🇧 Translates either plain text or someone's message. e.g. to translate something to English: opf-t en > bella ciao (or id of the message). Only on #multi-lingual-channel")
